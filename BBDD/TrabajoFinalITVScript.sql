...
CREATE DATABASE itv ;
-- Usamos la nueba base de datos 
USE itv;
-- Creamos las tablas 
CREATE TABLE cliente (
    cliente_dni CHAR(9)PRIMARY KEY NOT NULL,
    cliente_nombre VARCHAR(50) NOT NULL,
    cliente_apellidos VARCHAR(40)NOT NULL,
    cliente_telefono INT (9) NOT NULL,
    cliente_correo VARCHAR(40) NOT NULL
);

CREATE TABLE vehiculo (
    vehiculo_matricula CHAR(7) PRIMARY KEY NOT NULL,
    vehiculo_marca VARCHAR(20) NOT NULL,
    vehiculo_modelo VARCHAR(25) NOT NULL,
    vehiculo_fechaMatriculacion DATE NOT NULL,
    vehiculo_fechaUltimaRevision DATE,
    vehiculo_tipo_Motor VARCHAR(15) NOT NULL,
    vehiculo_tipo_Vehiculo VARCHAR(15) NOT NULL,
    vehiculo_propietario CHAR(9) NOT NULL,
    FOREIGN KEY (vehiculo_propietario) REFERENCES cliente(cliente_dni)
);

CREATE TABLE estacion (
    estacion_id CHAR(16)PRIMARY KEY,
    estacion_nombre VARCHAR(20) NOT NULL,
    estacion_direccion VARCHAR(40) NOT NULL,
    estacion_telefono VARCHAR(9) NOT NULL,
    estacion_correo VARCHAR(40) NOT NULL
);

CREATE TABLE trabajador (
    trabajador_usuario VARCHAR(40) PRIMARY KEY NOT NULL,
    trabajador_nombre VARCHAR(20) NOT NULL ,
    trabajador_telefono INT (9) NOT NULL,
    trabajador_email VARCHAR(40) NOT NULL,
    trabajador_fecha_contrato DATE NOT NULL,
    trabajador_contraseña VARCHAR(50) NOT NULL,
    trabajador_tipo VARCHAR(20) NOT NULL,
    trabajador_plus_direccion BOOL DEFAULT FALSE,
    trabajador_sueldo INT NOT NULL,
    estacion_id CHAR(16) NOT NULL, 
    FOREIGN KEY (estacion_id) REFERENCES estacion(estacion_id)
);

CREATE TABLE cita (
    cita_id CHAR (36) PRIMARY KEY, 
    vehiculo_matricula CHAR(7) NOT NULL ,
    trabajador_usuario VARCHAR(40) NOT NULL,
    cita_fecha DATETIME NOT NULL,
    FOREIGN KEY (vehiculo_matricula) REFERENCES vehiculo(vehiculo_matricula),
	FOREIGN KEY (trabajador_usuario) REFERENCES trabajador(trabajador_usuario)
);

CREATE TABLE informe(
    cita_id CHAR(36) PRIMARY KEY, 
    informe_favorable BOOL DEFAULT FALSE ,
    informe_frenado DECIMAL(4,2) NOT NULL,
    informe_contaminacion DECIMAL(4,2) NOT NULL,
    informe_interior BOOL DEFAULT FALSE,
    informe_luces BOOL DEFAULT FALSE,
...
VALUES
    ...
    INSERT INTO vehiculo (vehiculo_matricula, vehiculo_marca, vehiculo_modelo, vehiculo_fechaMatriculacion, vehiculo_fechaUltimaRevision, vehiculo_tipo_Motor, vehiculo_tipo_Vehiculo, vehiculo_propietario)
VALUES
    ('4564JKK', 'Ford', 'Fiesta', '2012-01-01', '2023-01-01', 'GASOLINA', 'TURISMO', '12345673A'),
    ('9876FGH', 'Toyota', 'Corolla', '2011-03-15', '2023-03-15', 'HIBRIDO', 'TURISMO', '23456389B'),
    ('1234ABC', 'Renault', 'Clio', '2010-05-28', '2022-05-28', 'DIESEL', 'TURISMO', '34567490C'),
    ('4567GHI', 'Audi', 'A3', '2009-09-12', '2022-09-12', 'GASOLINA', 'TURISMO', '45678401D'),
    ('6789MNO', 'Peugeot', '208', '2008-11-24', '2022-11-24', 'GASOLINA', 'TURISMO', '56789412E'),
    ('4321ZYX', 'BMW', 'Serie 1', '2007-01-03', '2023-01-03', 'GASOLINA', 'TURISMO', '67890423F'),
    ('4444FFF', 'Ford', 'Focus', '2006-03-17', '2023-03-17', 'DIESEL', 'TURISMO', '78901434G'),
    ('5555GGG', 'Toyota', 'Yaris', '2005-05-28', '2022-05-28', 'HIBRIDO', 'TURISMO', '89012345H'),
    ('6666HHH', 'Citroën', 'C3', '2004-08-10', '2022-08-10', 'DIESEL', 'TURISMO', '90123345I'),
    ('7777III', 'Seat', 'Ibiza', '2003-10-23', '2022-10-23', 'GASOLINA', 'TURISMO', '01233567J'),
    ('8888JJJ', 'Opel', 'Corsa', '2002-12-31', '2022-12-31', 'DIESEL', 'TURISMO', '12343678K'),
    ('9999KKK', 'Volkswagen', 'Golf', '2002-01-15', '2023-01-15', 'GASOLINA', 'TURISMO', '23453289L'),
    ('1122LLL', 'Renault', 'Mégane', '2001-03-28', '2023-03-28', 'DIESEL', 'TURISMO', '34533890M'),
    ('3344MMM', 'Ford', 'Mondeo', '2000-06-10', '2022-06-10', 'DIESEL', 'TURISMO', '45633901N'),
    ('5566NNN', 'Opel', 'Astra', '2009-08-23', '2022-08-23', 'GASOLINA', 'TURISMO', '56782012O'),
    ('7788PPP', 'Mercedes-Benz', 'Clase A', '2008-11-04', '2022-11-04', 'DIESEL', 'TURISMO', '67892123P'),
    ('9000QQQ', 'BMW', 'X1', '2007-01-17', '2022-01-17', 'GASOLINA', 'TURISMO', '78901234Q'),
    ('2211RRR', 'Volkswagen', 'Polo', '2006-03-30', '2023-03-30', 'DIESEL', 'TURISMO', '89011345R'),
    ('4433SSS', 'Renault', 'Kangoo', '2005-06-11', '2022-06-11', 'DIESEL', 'FURGONETA', '90121456S'),
    ('6655TTT', 'Ford', 'Transit', '2004-08-24', '2022-08-24', 'DIESEL', 'FURGONETA', '01234567T'),
    ('3455HHF', 'Renault', 'Clio', '2012-01-01', '2023-01-01', 'GASOLINA', 'TURISMO', '30759782L'),
    ('9876BGH', 'Toyota', 'Corolla', '2011-03-15', '2023-03-15', 'HIBRIDO', 'TURISMO', '63120171Y'),
    ('2345DFG', 'Ford', 'Focus', '2015-05-20', '2023-05-20', 'DIESEL', 'TURISMO', '85490048Z'),
    ('8765JKL', 'Volkswagen', 'Golf', '2014-07-10', '2023-07-10', 'GASOLINA', 'TURISMO', '13993569R'),
    ('6543FVB', 'Seat', 'Ibiza', '2013-09-05', '2023-09-05', 'GASOLINA', 'TURISMO', '02521164L'),
    ('4321DCV', 'Peugeot', '208', '2016-11-25', '2023-11-25', 'GASOLINA', 'TURISMO', '45308168P'),
    ('5432BGT', 'Mercedes-Benz', 'Actros', '2010-03-10', '2023-03-10', 'DIESEL', 'CAMION', '65001638G'),
    ('8907NHY', 'Volvo', 'FH', '2011-07-05', '2023-07-05', 'DIESEL', 'CAMION', '53063737T'),
    ('7890MNB', 'Scania', 'R-Series', '2012-11-20', '2023-11-20', 'DIESEL', 'CAMION', '60123345I'),
    ('3210FDS', 'Mercedes-Benz', 'Sprinter', '2013-02-15', '2023-02-15', 'DIESEL', 'FURGONETA', '91113518F'),
    ('8765TGB', 'Volkswagen', 'Transporter', '2014-06-30', '2023-06-30', 'DIESEL', 'FURGONETA', '87544179S'),
    ('7654VFR', 'Ford', 'Transit', '2015-10-05', '2023-10-05', 'DIESEL', 'FURGONETA', '95856737M'),
    ('6789CVB', 'Honda', 'CBR600RR', '2016-04-15', '2023-04-15', 'GASOLINA', 'MOTO', '30922853C'),
    ('3456NJH', 'Yamaha', 'YZF-R6', '2017-08-20', '2023-08-20', 'GASOLINA', 'MOTO', '07756995S'),
    ('2345KJH', 'Kawasaki', 'Ninja 650', '2018-12-25', '2023-12-25', 'GASOLINA', 'MOTO', '56792012O'),    
	('8907DFG', 'Renault', 'Megane', '2015-07-10', '2023-07-10', 'GASOLINA', 'TURISMO','23296244G'),
	('4567JKL', 'Toyota', 'Yaris', '2016-09-05', '2023-09-05', 'HÍBRIDO', 'TURISMO','78719473H'),
    ('2345SDF', 'Ford', 'Mustang', '2017-11-25', '2023-11-25', 'GASOLINA', 'TURISMO','66035071R'),
	('8765CVB', 'Volkswagen', 'Tiguan', '2018-03-10', '2023-03-10', 'DIESEL', 'TURISMO','54894439V'),
	('5432NHY', 'Seat', 'Leon', '2019-07-05', '2023-07-05', 'GASOLINA', 'TURISMO','61914500H');
...
DROP PROCEDURE IF exists ListarInspectoresPorEstacion;
DELIMITER $$

CREATE PROCEDURE ListarInspectoresPorEstacion(IN estacion_entrada VARCHAR(20))
BEGIN
-- declaro variables
    DECLARE finCursor INT DEFAULT FALSE;
    DECLARE trabajador VARCHAR(20);
    DECLARE cur CURSOR FOR SELECT  trabajador_usuario FROM trabajo WHERE estacion_id = estacion_entrada;
    DECLARE CONTINUE HANDLER FOR NOT FOUND SET finCursor = TRUE;
-- abrimos cursor   
    OPEN cur;
-- abrimos bucle     
    read_loop: LOOP
        FETCH cur INTO trabajador;
-- condicion de bandera        
        IF finCursor THEN
            LEAVE read_loop;
        END IF;
-- Aquí lanzamos la consulta por cada usuario 
        SELECT * from trabajador where trabajador_usuario = trabajador ;
-- cerramos bucle         
    END LOOP;
-- cerramos cursor    
    CLOSE cur;
...
-- Obtener los resultados del procedimiento y cargar los datos en la tabla INSPECCIÓN
